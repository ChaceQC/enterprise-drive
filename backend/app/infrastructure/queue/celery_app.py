...
celery_app = Celery(
    ...
    include=[
        ...
        "app.workers.governance_tasks",
        "app.workers.identity_tasks",
...
celery_app.conf.update(
    ...
    task_routes={
        ...
        "audit.ensure_partitions": {"queue": "maintenance"},
        "audit.archive_retention": {"queue": "maintenance"},
        ...
        "governance.process_permission_rebuilds": {"queue": "maintenance"},
        "governance.run_lifecycle_policy": {"queue": "maintenance"},
        "upload.expire_sessions": {"queue": "maintenance"},
        "identity.sync_ldap": {"queue": "maintenance"},
