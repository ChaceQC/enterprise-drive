...
class Node(Base):
    ...
    deleted_root_id: Mapped[UUID | None] = mapped_column(
        Uuid(as_uuid=True),
...
class FileBatchOperation(Base):
    __tablename__ = "file_batch_operations"
    __table_args__ = (
        Index(
...
class FileTreeOperation(Base):
    __tablename__ = "file_tree_operations"
    __table_args__ = (
        Index(
    ...
    node_id: Mapped[UUID] = mapped_column(Uuid(as_uuid=True), nullable=False, index=True)
    operation: Mapped[str] = mapped_column(String(16), nullable=False)
    status: Mapped[str] = mapped_column(String(16), nullable=False, default="pending")
    target_parent_id: Mapped[UUID | None] = mapped_column(Uuid(as_uuid=True), nullable=True)
