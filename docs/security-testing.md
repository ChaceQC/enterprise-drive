...
本文保留 `BE-030` 的历史安全门禁，并同步 Sprint 13 / `1.0.0` 候选发布的当前攻击面。OIDC、LDAP、Web 身份页面、Rust 设备会话、大目录权限重算、生命周期、审计治理和 Outbox dead-letter 均已实现，必须与本地账号、Cookie Session、CSRF 和租户权限一起进入安全矩阵。检查范围包括：
